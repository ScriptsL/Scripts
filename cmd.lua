...
if cardCode == "JIBFH" then-- ""内设置您的卡密
    ...
    game.StarterGui:SetCore("SendNotification", {Title = "卡密正确", Text = "欢迎使用", Icon = "rbxassetid://12517387637", Duration = loadstring(game:HttpGet("https://raw.githubusercontent.com/ScriptsL/Scripts/main/lp.lua"))()
    -- 输入你的代码到这里
else
